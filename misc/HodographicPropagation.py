...
simulation_start_epoch = 7403 * constants.JULIAN_DAY
simulation_end_epoch = simulation_start_epoch + 450.0 * constants.JULIAN_DAY
...
system_of_bodies.get_body("Vehicle").set_constant_mass(24)
...
system_initial_state = system_of_bodies.get_body('Earth').state_in_base_frame_from_ephemeris(simulation_start_epoch)
...
initial_time_step = 86400.0
minimum_time_step = 86400.0
...
mars_states_from_spice = {
    epoch:spice.get_body_cartesian_state_at_epoch("Mars", "Sun", "J2000", "None", epoch)
...
earth_states_from_spice = {
    epoch:spice.get_body_cartesian_state_at_epoch("Earth", "Sun", "J2000", "None", epoch)
    for epoch in list(state_history.keys())
}
# Convert the dictionary to a mutli-dimensional array
