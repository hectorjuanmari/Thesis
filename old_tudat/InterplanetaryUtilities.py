...
departure_epoch = 7200*constants.JULIAN_DAY
time_of_flight = 450*constants.JULIAN_DAY
...
def get_sensitivity_parameter_set(
    ...
    if use_rsw_acceleration == True:
        parameter_settings.append(estimation_setup.parameter.constant_empirical_acceleration_terms("Vehicle", "Sun"))
